...
/// The Android implementation of [TikTokAuthPlatform], built on the TikTok
/// OpenSDK Login Kit.
class TikTokAuthAndroid extends TikTokAuthPlatform {
  /// Creates the Android implementation.
  TikTokAuthAndroid({@visibleForTesting TikTokAuthHostApi? api})
  ...
  static void registerWith() {
    TikTokAuthPlatform.instance = TikTokAuthAndroid();
  }
